        ...
        <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
            ...
            <div class="dropdown text-end">
                <a href="#" class="d-block link-dark text-decoration-none dropdown-toggle" data-bs-toggle="dropdown"
                   aria-expanded="false">
                    <img src="${pageContext.request.contextPath}/assets/img/img4.png" alt="warehouse user" width="32"
                         height="32"
                         class="rounded-circle">
                </a>
                <!-- drop profile menu items -->
                <ul class="dropdown-menu text-small">
                    <li><a class="dropdown-item" href="#">Crear envío</a></li>
                    <li><a class="dropdown-item" href="#">Resolver incidencia</a></li>
                    <li><a class="dropdown-item" href="#">Resolver devolución</a></li>
        ...
        <div class="row row-cols-1 row-cols-md-2 mb-3 text-center">
            ...
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                    ...
                    <div class="card-body">
                        <h3 class="card-title">Envíos generados a tienda en un intervalo de tiempo</h3>
            ...
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                    ...
                    <div class="card-body">
                        <h3 class="card-title">Incidencias solucionadas a tienda en un intervalo de tiempo</h3>
                        <a href="#" class="w-100 btn btn-lg btn-outline-primary">Ver reporte</a>
                    </div>
                </div>
            </div>
        ...
        <div class="row row-cols-1 row-cols-md-1 mb-3 text-center">
            ...
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                    ...
                    <div class="card-body">
                        <h3 class="card-title">Devoluciones a tienda en un intervalo de tiempo</h3>
                        <a href="#" class="w-100 btn btn-lg btn-outline-primary">Ver reporte</a>
                    </div>
                </div>
            </div>
